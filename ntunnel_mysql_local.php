...
<fieldset>
	...
	<input type=hidden id="actn" value="Q">
	<input type=hidden id="q" value="SELECT * FROM ordenes">
	<table>
...
$link = EchoData;
		...
		$result = mysql_query($q_detalle, $conn) or die("Error en: $q_detalle".mysql_error());
